...
const struct blockcipher_info pem_dek_infos[] =
   {
      ...
      { .name = "ARIA-128-CBC,",      .algo = "aria",     .keylen = 128 / 8, .mode = cm_cbc,    },
      { .name = "ARIA-192-CBC,",      .algo = "aria",     .keylen = 192 / 8, .mode = cm_cbc,    },
      { .name = "ARIA-256-CBC,",      .algo = "aria",     .keylen = 256 / 8, .mode = cm_cbc,    },
      { .name = "ARIA-128-CFB,",      .algo = "aria",     .keylen = 128 / 8, .mode = cm_cfb,    },
      { .name = "ARIA-192-CFB,",      .algo = "aria",     .keylen = 192 / 8, .mode = cm_cfb,    },
      { .name = "ARIA-256-CFB,",      .algo = "aria",     .keylen = 256 / 8, .mode = cm_cfb,    },
      { .name = "ARIA-128-CFB1,",     .algo = "aria",     .keylen = 128 / 8, .mode = cm_cfb1,   },
      { .name = "ARIA-192-CFB1,",     .algo = "aria",     .keylen = 192 / 8, .mode = cm_cfb1,   },
      { .name = "ARIA-256-CFB1,",     .algo = "aria",     .keylen = 256 / 8, .mode = cm_cfb1,   },
      { .name = "ARIA-128-CFB8,",     .algo = "aria",     .keylen = 128 / 8, .mode = cm_cfb8,   },
      { .name = "ARIA-192-CFB8,",     .algo = "aria",     .keylen = 192 / 8, .mode = cm_cfb8,   },
      { .name = "ARIA-256-CFB8,",     .algo = "aria",     .keylen = 256 / 8, .mode = cm_cfb8,   },
      { .name = "ARIA-128-CTR,",      .algo = "aria",     .keylen = 128 / 8, .mode = cm_ctr,    },
      { .name = "ARIA-192-CTR,",      .algo = "aria",     .keylen = 192 / 8, .mode = cm_ctr,    },
      { .name = "ARIA-256-CTR,",      .algo = "aria",     .keylen = 256 / 8, .mode = cm_ctr,    },
      { .name = "ARIA-128-OFB,",      .algo = "aria",     .keylen = 128 / 8, .mode = cm_ofb,    },
      { .name = "ARIA-192-OFB,",      .algo = "aria",     .keylen = 192 / 8, .mode = cm_ofb,    },
      { .name = "ARIA-256-OFB,",      .algo = "aria",     .keylen = 256 / 8, .mode = cm_ofb,    },

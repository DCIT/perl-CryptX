...
sub new {
  my ($class, @args) = @_;
  my $obj = Crypt::Cipher->new('SM4', @args);
  return bless $obj, $class;
}

sub blocksize      { Crypt::Cipher::blocksize('SM4')      }
sub keysize        { Crypt::Cipher::keysize('SM4')        }
sub max_keysize    { Crypt::Cipher::max_keysize('SM4')    }
sub min_keysize    { Crypt::Cipher::min_keysize('SM4')    }
sub default_rounds { Crypt::Cipher::default_rounds('SM4') }
...
This module implements the SM4 cipher. Provided interface is compliant with L<Crypt::CBC|Crypt::CBC> module.
...
=head2 new
 ...
 my $c = Crypt::Cipher::SM4->new($key);
 #or
 my $c = Crypt::Cipher::SM4->new($key, $rounds);
...
Returns the cipher's default round count.
  ...
  $c->default_rounds;
  #or
  Crypt::Cipher::SM4->default_rounds;
  #or
  Crypt::Cipher::SM4::default_rounds;
...
=item * L<https://en.wikipedia.org/wiki/SM4_(cipher)>

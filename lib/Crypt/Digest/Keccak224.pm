...
Joins all arguments into a single string and returns its Keccak224 digest encoded as a Base64 string, B<with> trailing '=' padding.
...
Reads a file given by a filename or filehandle and returns its Keccak224 digest encoded as a Base64 string, B<with> trailing '=' padding.

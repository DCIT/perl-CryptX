...
sub new {
  my ($class) = @_;
  my $obj = Crypt::Digest->new('Tiger192');
...
rules apply to C<tiger192_hex>, C<tiger192_b64>, and
C<tiger192_b64u>.
...
Joins all arguments into a single string and returns its Tiger192 digest encoded as a Base64 string, B<with> trailing '=' padding.
...
Reads a file given by a filename or filehandle and returns its Tiger192 digest encoded as a Base64 string, B<with> trailing '=' padding.

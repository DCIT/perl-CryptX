...
sub new {
  my ($class) = @_;
  my $obj = Crypt::Digest->new('SHA512_256');
...
=head1 SYNOPSIS
   ...
   my $data = 'data string';
   my $sha512_256_raw  = sha512_256($data);
   my $sha512_256_hex  = sha512_256_hex($data);
   my $sha512_256_b64  = sha512_256_b64($data);
   my $sha512_256_b64u = sha512_256_b64u($data);
   # or from file
   my $sha512_256_file_raw  = sha512_256_file('filename.dat');
   my $sha512_256_file_hex  = sha512_256_file_hex('filename.dat');
   my $sha512_256_file_b64  = sha512_256_file_b64('filename.dat');
   my $sha512_256_file_b64u = sha512_256_file_b64u('filename.dat');
   # or from filehandle
   my $filehandle = ...; # existing binary-mode filehandle
   my $sha512_256_fh_raw  = sha512_256_file($filehandle);
   my $sha512_256_fh_hex  = sha512_256_file_hex($filehandle);
   my $sha512_256_fh_b64  = sha512_256_file_b64($filehandle);
   my $sha512_256_fh_b64u = sha512_256_file_b64u($filehandle);
   ...
   my $file_result_raw = Crypt::Digest::SHA512_256->new->addfile('filename.dat')->digest;
...
Joins all arguments into a single string and returns its SHA512_256 digest encoded as a binary string.
...
rules apply to C<sha512_256_hex>, C<sha512_256_b64>, and
C<sha512_256_b64u>.

 my $sha512_256_raw = sha512_256('data string');
 #or
 my $sha512_256_raw = sha512_256('any data', 'more data', 'even more data');

=head2 sha512_256_hex

Joins all arguments into a single string and returns its SHA512_256 digest encoded as a hexadecimal string.

 my $sha512_256_hex = sha512_256_hex('data string');
 #or
 my $sha512_256_hex = sha512_256_hex('any data', 'more data', 'even more data');

=head2 sha512_256_b64

Joins all arguments into a single string and returns its SHA512_256 digest encoded as a Base64 string, B<with> trailing '=' padding.

 my $sha512_256_b64 = sha512_256_b64('data string');
 #or
 my $sha512_256_b64 = sha512_256_b64('any data', 'more data', 'even more data');

=head2 sha512_256_b64u

Joins all arguments into a single string and returns its SHA512_256 digest encoded as a Base64 URL-safe string (see RFC 4648 section 5).

 my $sha512_256_b64url = sha512_256_b64u('data string');
 #or
 my $sha512_256_b64url = sha512_256_b64u('any data', 'more data', 'even more data');

=head2 sha512_256_file

Reads a file given by a filename or filehandle and returns its SHA512_256 digest encoded as a binary string.

 my $sha512_256_raw = sha512_256_file('filename.dat');
 #or
 my $filehandle = ...; # existing binary-mode filehandle
 my $sha512_256_raw = sha512_256_file($filehandle);

=head2 sha512_256_file_hex

Reads a file given by a filename or filehandle and returns its SHA512_256 digest encoded as a hexadecimal string.

 my $sha512_256_hex = sha512_256_file_hex('filename.dat');
 #or
 my $filehandle = ...; # existing binary-mode filehandle
 my $sha512_256_hex = sha512_256_file_hex($filehandle);

B<Note:> The filehandle must be in binary mode before you pass it to C<addfile()>.

=head2 sha512_256_file_b64

Reads a file given by a filename or filehandle and returns its SHA512_256 digest encoded as a Base64 string, B<with> trailing '=' padding.

 my $sha512_256_b64 = sha512_256_file_b64('filename.dat');
 #or
 my $filehandle = ...; # existing binary-mode filehandle
 my $sha512_256_b64 = sha512_256_file_b64($filehandle);

=head2 sha512_256_file_b64u

Reads a file given by a filename or filehandle and returns its SHA512_256 digest encoded as a Base64 URL-safe string (see RFC 4648 section 5).

 my $sha512_256_b64url = sha512_256_file_b64u('filename.dat');
 #or
 my $filehandle = ...; # existing binary-mode filehandle
 my $sha512_256_b64url = sha512_256_file_b64u($filehandle);

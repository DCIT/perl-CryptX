...
sub new {
  my ($class) = @_;
  my $obj = Crypt::Digest->new('RIPEMD160');
...
=head1 SYNOPSIS
   ...
   my $data = 'data string';
   my $ripemd160_raw  = ripemd160($data);
   my $ripemd160_hex  = ripemd160_hex($data);
   my $ripemd160_b64  = ripemd160_b64($data);
   my $ripemd160_b64u = ripemd160_b64u($data);
   # or from file
   my $ripemd160_file_raw  = ripemd160_file('filename.dat');
   my $ripemd160_file_hex  = ripemd160_file_hex('filename.dat');
   my $ripemd160_file_b64  = ripemd160_file_b64('filename.dat');
   my $ripemd160_file_b64u = ripemd160_file_b64u('filename.dat');
   # or from filehandle
   my $filehandle = ...; # existing binary-mode filehandle
   my $ripemd160_fh_raw  = ripemd160_file($filehandle);
   my $ripemd160_fh_hex  = ripemd160_file_hex($filehandle);
   my $ripemd160_fh_b64  = ripemd160_file_b64($filehandle);
   my $ripemd160_fh_b64u = ripemd160_file_b64u($filehandle);
   ...
   my $file_result_raw = Crypt::Digest::RIPEMD160->new->addfile('filename.dat')->digest;
...
Joins all arguments into a single string and returns its RIPEMD160 digest encoded as a binary string.
...
rules apply to C<ripemd160_hex>, C<ripemd160_b64>, and
C<ripemd160_b64u>.

 my $ripemd160_raw = ripemd160('data string');
 #or
 my $ripemd160_raw = ripemd160('any data', 'more data', 'even more data');

=head2 ripemd160_hex

Joins all arguments into a single string and returns its RIPEMD160 digest encoded as a hexadecimal string.

 my $ripemd160_hex = ripemd160_hex('data string');
 #or
 my $ripemd160_hex = ripemd160_hex('any data', 'more data', 'even more data');

=head2 ripemd160_b64

Joins all arguments into a single string and returns its RIPEMD160 digest encoded as a Base64 string, B<with> trailing '=' padding.

 my $ripemd160_b64 = ripemd160_b64('data string');
 #or
 my $ripemd160_b64 = ripemd160_b64('any data', 'more data', 'even more data');

=head2 ripemd160_b64u

Joins all arguments into a single string and returns its RIPEMD160 digest encoded as a Base64 URL-safe string (see RFC 4648 section 5).

 my $ripemd160_b64url = ripemd160_b64u('data string');
 #or
 my $ripemd160_b64url = ripemd160_b64u('any data', 'more data', 'even more data');

=head2 ripemd160_file

Reads a file given by a filename or filehandle and returns its RIPEMD160 digest encoded as a binary string.

 my $ripemd160_raw = ripemd160_file('filename.dat');
 #or
 my $filehandle = ...; # existing binary-mode filehandle
 my $ripemd160_raw = ripemd160_file($filehandle);

=head2 ripemd160_file_hex

Reads a file given by a filename or filehandle and returns its RIPEMD160 digest encoded as a hexadecimal string.

 my $ripemd160_hex = ripemd160_file_hex('filename.dat');
 #or
 my $filehandle = ...; # existing binary-mode filehandle
 my $ripemd160_hex = ripemd160_file_hex($filehandle);

B<Note:> The filehandle must be in binary mode before you pass it to C<addfile()>.

=head2 ripemd160_file_b64

Reads a file given by a filename or filehandle and returns its RIPEMD160 digest encoded as a Base64 string, B<with> trailing '=' padding.

 my $ripemd160_b64 = ripemd160_file_b64('filename.dat');
 #or
 my $filehandle = ...; # existing binary-mode filehandle
 my $ripemd160_b64 = ripemd160_file_b64($filehandle);

=head2 ripemd160_file_b64u

Reads a file given by a filename or filehandle and returns its RIPEMD160 digest encoded as a Base64 URL-safe string (see RFC 4648 section 5).

 my $ripemd160_b64url = ripemd160_file_b64u('filename.dat');
 #or
 my $filehandle = ...; # existing binary-mode filehandle
 my $ripemd160_b64url = ripemd160_file_b64u($filehandle);

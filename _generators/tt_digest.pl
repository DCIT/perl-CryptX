...
my %list = (
        ...
        SHA3_224    => { ltc=>'sha3-224',    info=>'Hash function SHA3-224 [size: 224 bits]', urls=>['http://en.wikipedia.org/wiki/SHA-3'] },
        SHA3_256    => { ltc=>'sha3-256',    info=>'Hash function SHA3-256 [size: 256 bits]', urls=>['http://en.wikipedia.org/wiki/SHA-3'] },
        SHA3_384    => { ltc=>'sha3-384',    info=>'Hash function SHA3-384 [size: 384 bits]', urls=>['http://en.wikipedia.org/wiki/SHA-3'] },
        SHA3_512    => { ltc=>'sha3-512',    info=>'Hash function SHA3-512 [size: 512 bits]', urls=>['http://en.wikipedia.org/wiki/SHA-3'] },

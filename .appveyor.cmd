...
if "%perl_type%" == "cygwin32" (
  ...
  if "%perl_version%" == "5.40" (
    wget -q https://github.com/StrawberryPerl/Perl-Dist-Strawberry/releases/download/SP_54001_64bit_UCRT/strawberry-perl-5.40.0.1-64bit-portable.zip -O downloaded-strawberry.zip
  ) else if "%perl_version" == "5.38" (
    wget -q https://github.com/StrawberryPerl/Perl-Dist-Strawberry/releases/download/SP_53822_64bit/strawberry-perl-5.38.2.2-64bit-portable.zip -O downloaded-strawberry.zip
  ) else if "%perl_version" == "5.36" (
    wget -q https://github.com/StrawberryPerl/Perl-Dist-Strawberry/releases/download/SP_53631_64bit/strawberry-perl-5.36.3.1-64bit-portable.zip -O downloaded-strawberry.zip
  )

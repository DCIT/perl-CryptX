...
is( Crypt::Digest::BLAKE2b_512->new->hashsize, 64, 'hashsize/6');
{
  ...
  isa_ok($d, 'Crypt::Digest::BLAKE2b_512', 'new returns subclass instance');
  isa_ok($d->clone, 'Crypt::Digest::BLAKE2b_512', 'clone returns subclass instance');
}
{
  my $d = Crypt::Digest::BLAKE2b_512->new->add("abc");
  my $c = $d->clone;
  is($d->hexdigest, "ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac4b74b12bb6fdbffa2d17d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd4009923", 'blake2b_512 (clone/original-first/original)');
  is($c->hexdigest, "ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac4b74b12bb6fdbffa2d17d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd4009923", 'blake2b_512 (clone/original-first/clone)');
}
{
  my $d = Crypt::Digest::BLAKE2b_512->new->add("abc");
  my $c = $d->clone;
  is($c->hexdigest, "ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac4b74b12bb6fdbffa2d17d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd4009923", 'blake2b_512 (clone/clone-first/clone)');
  is($d->hexdigest, "ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac4b74b12bb6fdbffa2d17d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd4009923", 'blake2b_512 (clone/clone-first/original)');
}
{
  my $d = Crypt::Digest::BLAKE2b_512->new->add("AAA");
  is($d->digest, pack("H*","dda5c92ae5adba047d317f99dc58a9059b5a8c0907f95d8cddcf5bfdaa8e4c74ddd84bc2683cdc2d16a340ff5798e1bf4bd2c838332611f266bb62870d33b823"), 'blake2b_512 (OO/digest/finalizes)');
  dies_like(sub { $d->hexdigest }, qr/already finalized/, 'blake2b_512 (OO/hexdigest/after-digest-croaks)');
  dies_like(sub { $d->add("X") }, qr/already finalized/, 'blake2b_512 (OO/add-after-digest-croaks)');
  is($d->reset->add("AAA","X")->hexdigest, "7e7bdfff2bc932483d86a7e1a98d1fe9a5590672e34b242f48a6070b4972f4629b49b72a9ed1545e8e05f58d3b24c9e9f0e5b256eaba6a2a80de1e6a4929422a", 'blake2b_512 (OO/reset-after-digest)');
  $d = Crypt::Digest::BLAKE2b_512->new->add("AAA");
  is($d->hexdigest, "dda5c92ae5adba047d317f99dc58a9059b5a8c0907f95d8cddcf5bfdaa8e4c74ddd84bc2683cdc2d16a340ff5798e1bf4bd2c838332611f266bb62870d33b823", 'blake2b_512 (OO/hexdigest/finalizes)');
  dies_like(sub { $d->hexdigest }, qr/already finalized/, 'blake2b_512 (OO/hexdigest/repeat-croaks)');
  $d = Crypt::Digest::BLAKE2b_512->new->add("AAA");
  is($d->b64digest, "3aXJKuWtugR9MX+Z3FipBZtajAkH+V2M3c9b/aqOTHTd2EvCaDzcLRajQP9XmOG/S9LIODMmEfJmu2KHDTO4Iw==", 'blake2b_512 (OO/b64digest/finalizes)');
  $d = Crypt::Digest::BLAKE2b_512->new->add("AAA");
  is($d->b64udigest, "3aXJKuWtugR9MX-Z3FipBZtajAkH-V2M3c9b_aqOTHTd2EvCaDzcLRajQP9XmOG_S9LIODMmEfJmu2KHDTO4Iw", 'blake2b_512 (OO/b64udigest/finalizes)');
}

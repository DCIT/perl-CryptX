...
}
{
  ...
  is($d->digest, pack("H*","cb1ad2119d8fafb69566510ee712661f9f14b83385006ef92aec47f523a38358"), 'sha256 (OO/digest/finalizes)');
  dies_like(sub { $d->hexdigest }, qr/already finalized/, 'sha256 (OO/hexdigest/after-digest-croaks)');
  dies_like(sub { $d->add("X") }, qr/already finalized/, 'sha256 (OO/add-after-digest-croaks)');
  is($d->reset->add("AAA","X")->hexdigest, "2b33d46f7190b4780aba028480c589e53f5a2f74bb536bee42b338f09d064d82", 'sha256 (OO/reset-after-digest)');
  $d = Crypt::Digest::SHA256->new->add("AAA");
  is($d->hexdigest, "cb1ad2119d8fafb69566510ee712661f9f14b83385006ef92aec47f523a38358", 'sha256 (OO/hexdigest/finalizes)');
  dies_like(sub { $d->hexdigest }, qr/already finalized/, 'sha256 (OO/hexdigest/repeat-croaks)');
  $d = Crypt::Digest::SHA256->new->add("AAA");
  is($d->b64digest, "yxrSEZ2Pr7aVZlEO5xJmH58UuDOFAG75KuxH9SOjg1g=", 'sha256 (OO/b64digest/finalizes)');
  $d = Crypt::Digest::SHA256->new->add("AAA");
  is($d->b64udigest, "yxrSEZ2Pr7aVZlEO5xJmH58UuDOFAG75KuxH9SOjg1g", 'sha256 (OO/b64udigest/finalizes)');
}

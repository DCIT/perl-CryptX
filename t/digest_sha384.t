...
is( Crypt::Digest::SHA384->new->hashsize, 48, 'hashsize/6');
{
  ...
  isa_ok($d, 'Crypt::Digest::SHA384', 'new returns subclass instance');
  isa_ok($d->clone, 'Crypt::Digest::SHA384', 'clone returns subclass instance');
}
{
  my $d = Crypt::Digest::SHA384->new->add("abc");
  my $c = $d->clone;
  is($d->hexdigest, "cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7", 'sha384 (clone/original-first/original)');
  is($c->hexdigest, "cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7", 'sha384 (clone/original-first/clone)');
}
{
  my $d = Crypt::Digest::SHA384->new->add("abc");
  my $c = $d->clone;
  is($c->hexdigest, "cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7", 'sha384 (clone/clone-first/clone)');
  is($d->hexdigest, "cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7", 'sha384 (clone/clone-first/original)');
}
{
